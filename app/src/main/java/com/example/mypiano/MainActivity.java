...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupButtonWithSound(R.id.button2, R.raw.b3);
        setupButtonWithSound(R.id.button3, R.raw.a3);
        ...
        setupButtonWithSound(R.id.button9, R.raw.b3);
        setupButtonWithSound(R.id.button10, R.raw.a3);
